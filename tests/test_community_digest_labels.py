...
def _nodes():
    ...
    return [
        {
            "id": "a",
            "label": "MIReportService",
            "repo": "cp-example-portal",
            "source_file": "a.java",
        },
        {"id": "b", "label": "ReportRow", "repo": "cp-example-portal", "source_file": "b.java"},
...
class DerivedLabelTest(SettingsIsolated):
    ...
    def test_a_community_absent_from_the_labels_file_is_named_from_evidence(self):
        ...
        self.assertIn("cp-example-portal", digest["label"])
    ...
    def test_a_labelless_node_does_not_produce_a_dangling_separator(self):
        ...
        nodes = [{"id": "a", "label": "", "repo": "cp-example-portal", "source_file": None}]
        digest = summaries.community_digest(42, nodes, {}, {}, {"a": 1})
        self.assertEqual(digest["label"], "cp-example-portal")
